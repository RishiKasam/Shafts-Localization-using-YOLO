...
class SpecialYOLO(object):
    def __init__(self, input_width,
        ...
        q=self.model.summary(positions=[.25, .60, .80, 1.])
    ...
    def custom_loss(self, y_true, y_pred):
        ...
        true_kpp_conf = (y_true[..., 3]) # confidence
        ...
        loss = tf.cond(tf.less(self.seen, self.warmup_batches+1),
                      lambda: loss_kp0_xy + loss_alpha + loss_conf + loss_class, # +10, # Adding bias as 10
    ...
    def train(self, train_imgs,     # the list of images to train the model
        ...
        image = cv2.imread("C:\\imagescupstrainvalid\\train\\Img_000026.bmp")
